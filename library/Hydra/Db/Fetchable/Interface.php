 ...
 * Hydra_Db_Statement_Interface::fetchObject.
 *
 * @author <a href="mailto:rick.hjpbacelos@gmail.com">Henrique Barcelos</a>
 */
interface Hydra_Db_Fetchable_Interface {
	/**
	 ...
	 * @param string $key
	 * @param mixed $newVal
	 * @return Hydra_Db_Fetchable_Interface : fluent interface
	 * @throws Hydra_Db_Fetchable_Exception caso não exista a chave $key
	 */
