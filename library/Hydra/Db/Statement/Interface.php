 ...
 */
interface Hydra_Db_Statement_Interface {
	 ...
	 * @return Hydra_Db_Statement_Interface : Fluent Interface
	 ...
	 * @return Hydra_Db_Statement_Interfacae : Fluent Interface
	 * @throws Hydra_Db_Statement_Exception
	 */
	 ...
	 *
	 * @param Hydra_Db::FETCH_* $mode [OPCIONAL] : modo de busca
	 ...
	 * 		Se a classe não for 'stdClass', deve implementar a interface Hydra_Db_Fetchable_Interface
