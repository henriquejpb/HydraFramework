 ...
 */
abstract class Hydra_FileSystem {
	/**
	 ...
	 * @throws Hydra_FileSystem_Exception
	 * @return bool
	 */
	public function setMode($mode){
		$vMode = (int) '0'.base_convert($mode, 10, 8);
		if(!preg_match('#0[0-7]+#', $vMode)) {
			throw new Hydra_FileSystem_Exception(sprintf('Modo de permissão "%s" inválido!', $mode));
		}
	...
	/**
	 * Ao tentar converter um objeto Hydra_FileSystem em string,
